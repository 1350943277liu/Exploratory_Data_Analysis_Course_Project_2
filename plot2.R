...
totalpm25 <- tapply(NEI.baltimore$Emissions, NEI.baltimore$year, sum)

options(scipen = 2)
plot(unique(NEI.baltimore$year), totalpm25, type = "l", ann = FALSE)
title(main = "Total PM 2.5 Change in Baltimore City", xlab = "Year", ylab = "PM 2.5 Emission (tons)")